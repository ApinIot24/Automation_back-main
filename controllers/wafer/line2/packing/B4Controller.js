...
// ==== Packing B4 Controllers ====
export const GetPackingB4 = async (req, res) => {
  try {
    const rows = await iotDB.packing_b4.findMany({
      orderBy: { id: "desc" },
      take: 1
    });
    res.json(rows);
  } catch (err) {
    console.error("Error /packing_b4", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4All = async (req, res) => {
  try {
    const rows = await iotDB.packing_b4.findMany({
      where: { graph: "Y" },
      orderBy: { id: "desc" }
    ...
    console.error("Error /packing_b4_all", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4Counter = async (req, res) => {
  try {
    const rows = await iotDB.packing_b4.findMany({
      orderBy: { id: "desc" },
      select: { counter: true },
    ...
    res.json(rows.map(r => r.counter));
  } catch (err) {
    console.error("Error /packing_b4_counter", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
// ==== SHIFT ====
export const GetPackingB4Shift1 = async (req, res) => {
  try {
    ...
    console.error("Error /shift1_b4", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4Shift2 = async (req, res) => {
  try {
    const data = await getShiftDataToday(
      iotDB.packing_b4,
      JamListNormalShift2,
    ...
    console.error("Error /shift2_b4", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4Shift3 = async (req, res) => {
  try {
...
// ==== HOURLY & BY DATE ====
export const GetPackingB4Hourly = async (req, res) => {
  try {
    ...
    console.error("Error /packing_b4_hourly", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4HourlyByDate = async (req, res) => {
  try {
    ...
    console.error("Error /packing_b4_hourly/date", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
// ==== DAILY & WEEKLY ====
export const GetPackingB4Daily = async (req, res) => {
  try {
    const today = new Date();
    ...
    console.error("Error /packing_b4_daily", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4DailyByDate = async (req, res) => {
  try {
    const dateThis = req.params.date;
    ...
    console.error("Error /packing_b4_daily/date", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4Weekly = async (req, res) => {
  try {
    const now = new Date();
    ...
    console.error("Error /packing_b4_weekly", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};
export const GetPackingB4WeeklyByDate = async (req, res) => {
  try {
    ...
    console.error("Error /packing_b4_weekly/date", err);
    res.status(500).json({ error: "Internal Server Error" });
  }
};