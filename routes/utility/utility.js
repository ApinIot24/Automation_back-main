...
import { getHistoryAkhir, getHistoryByHourRange, getHistoryPerHour, getHistoryTableRange } from "../../controllers/utility/utilityController.js";

const app = Router();
const now = moment();
app.get("/history/table/:utility/:kwhpm/:start_date/:end_date/", getHistoryTableRange
  // async (req, res) => {
...
app.get("/history/table/hours/:utility/:kwhpm/:start_date/:end_date/", getHistoryPerHour
//   async (req, res) => {
//     const { utility, kwhpm, start_date, end_date } = req.params;
...
app.get("/history/:utility/:start_date/:start_hour/:end_date/:end_hour", getHistoryByHourRange
  // async (req, res) => {
...
app.get("/history/akhir/:utility/:kwhpm/:date", getHistoryAkhir
  // async (req, res) => {
