...
function getWeek(date) {
  ...
  monthStart.setDate(0); // satu hari sebelum tanggal 1
...
app.get('/shift1_b4', async (req, res) => {
  try {
    ...
    console.error('Error in GET /shift1_b4:', error.message);
...
app.get('/shift2_b4', async (req, res) => {
  try {
    ...
    console.error('Error in GET /shift2_b4:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});
...
app.get('/shift3_b4', async (req, res) => {
  try {
    ...
    console.error('Error in GET /shift3_b4:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});

// 4. packing_b4 (data terakhir)
app.get('/packing_b4', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});

// 5. packing_b4_all (graph = 'Y')
app.get('/packing_b4_all', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_all:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});

// 6. packing_b4_counter (7 data terakhir)
app.get('/packing_b4_counter', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_counter:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});
...
app.get('/packing_b4_hourly', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_hourly:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});

// 8. packing_b4_hourly dengan parameter date
app.get('/packing_b4_hourly/date/:date', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_hourly/date/:date:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});
...
app.get('/packing_b4_daily', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_daily:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});

// 10. packing_b4_daily dengan parameter date
app.get('/packing_b4_daily/date/:date', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_daily/date/:date:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});

// 11. packing_b4_weekly
app.get('/packing_b4_weekly', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_weekly:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});

// 12. packing_b4_weekly dengan parameter date
app.get('/packing_b4_weekly/date/:date', async (req, res) => {
  try {
    ...
    console.error('Error in GET /packing_b4_weekly/date/:date:', error.message);
    res.status(500).json({ error: 'Internal Server Error' });
  }
});
